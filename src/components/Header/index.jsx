...
const Header = () => {
  ...
  return <Box className="header-container" sx={styles.headerContainer}>
      <Box className="header-contents" sx={styles.headerContents}>
        ...
        <Box className="right-section" sx={styles.rightSection}>
          <PrimaryButton startIcon={<ShoppingCartOutlinedIcon />} title="Checkout(200)" width="210px" onClick={() => {}} />

          <Box className="avatar-profile" sx={styles.avatarProfile}
        ...
        >
            ...
            <Typography onClick={handleClick} aria-controls={open ? "account-menu" : undefined} aria-haspopup="true" aria-expanded={open ? "true" : undefined} sx={{
            ml: 2,
            mr: 2,
            fontWeight: 500,
            fontSize: "16px"
